...
/** Modification of Lucene Standard Tokenizer Impl
...
public final class CustomWordBoundaryStandardTokenizerImpl {
   ...
   * string
   */
  public static final Character WB_CLASS_BREAK               = (char)0;
  public static final Character WB_CLASS_LETTER              = (char)1;
  public static final Character WB_CLASS_NUMERIC             = (char)4;
  public static final Character WB_CLASS_MID_LETTER          = (char)6;
  public static final Character WB_CLASS_MID_NUMBER          = (char)7;
  public static final Character WB_CLASS_MID_NUMBER_LETTER   = (char)8;
  public static final Character WB_CLASS_EXTENDED_NUM_LETTER = (char)9;
  public static final Character WB_CLASS_SINGLE_QUOTE        = (char)12;
  public static final Character WB_CLASS_DOUBLE_QUOTE        = (char)13;
   ...
   */
  public CustomWordBoundaryStandardTokenizerImpl(java.io.Reader in) {
   ...
   */
  public CustomWordBoundaryStandardTokenizerImpl(java.io.Reader in, Map<Character, Character> cmap) {
    this.zzReader = in;
  ...
  private static char[] zzFillCMapExt(Map<Character, Character> cmap) {
    ...
    // char after = map[35];
    // if (true)
    //   throw new Error(before + " toto " + after + " titi " + map[(int)'a'] + " tata " + map[(int)'_'] + " / "+ map[(int)',']);
    return map;
  }
